 ...
 * Time: 23:50
 */
$page_title="Admin: Cloture des transactions";
...
?>
    ...
    <div id="corps">
        <script>
            jQuery(document).ready(function()
            {
                jQuery('.BtnValid').click(function()
                {
                    ...
                    var postData="transactionId="+transactionId+"&type=cloture";
                    $.ajax({
                        type:'POST',
                        data: postData,
                        dataType: 'json',
        ...
        ?>
        <h2 align="center">Transaction à cloturer </h2>
        </br>
        <table class="table table-bordered">
            <thead>
            <tr>
                <th>Reférence</th>
                <th style="text-align: center">Montant transaction</th>
            ...
            while($transaction= $req->fetch()):
                ...
                <tr>
                    ...
                    <td><a data-toggle="modal" data-target="#myModal" data-id="<?php echo $idTransac;?>" role="button" class="btn btn-primary btn-sm BtnValid" href="#">Details  </a><a style="float: right" role="button" class="btn btn-success btn-sm" href="cloturerTransaction.php?id=<?php echo $idTransac?>"> Cloturer</a> </td>
                </tr>
            <?php endwhile; ?>
