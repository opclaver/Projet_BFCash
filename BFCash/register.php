...
?>
    ...
    <div id="inscription">
        ...
        <form class="form-horizontal" role="form" action="" method="post">
            ...
            <div class="form-group">
                <label class="control-label col-sm-3" for="dateNaiss">&nbsp;&nbsp;Date de naissance:</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="dateNaiss" id="dateNaiss" placeholder="Veuillez Entrer votre date de naissance" >
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label class="control-label col-sm-3" for="nom">&nbsp;&nbsp;Téléphone:</label>
                <div class="col-sm-6">
            ...
            <div class="form-group">
                <label class="control-label col-sm-3" for="nom">&nbsp;&nbsp;Profession:</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="profession" placeholder="Veuillez Entrer votre profession ">
                </div>
            </div>

            <div class="form-group">
                <label class="control-label col-sm-3" for="nom">&nbsp;&nbsp;Voulez vous Recevoir des Notifications ?:</label>
                <div class="col-sm-6">
                    <label class="radio-inline">
                        <input type="radio" name="recevoirNotif" value="true"> Oui
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="recevoirNotif" value="false"> Non
                    </label>
                </div>
            </div>
