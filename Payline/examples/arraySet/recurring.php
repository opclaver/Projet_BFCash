...
if (isset($_POST['recurringEndDate'])) $array['recurring']['endDate'] = $_POST['recurringEndDate']; 
if (isset($_POST['recurringNewAmount'])) $array['recurring']['newAmount'] = $_POST['recurringNewAmount']; 
if (isset($_POST['recurringAmountModificationDate'])) $array['recurring']['amountModificationDate'] = $_POST['recurringAmountModificationDate'];  
?>