<?php
// CARD INFO
$array['card']['encryptionKeyId'] = $_POST['encryptionKeyId'];
$array['card']['encryptedData'] = $_POST['encryptedData'];
...
$array['card']['token'] = $_POST['cardToken'];
$array['card']['cardholder'] = $_POST['cardHolder'];
?>