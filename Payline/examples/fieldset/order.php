<fieldset>
	...
	<div class="row">
		...
		<input type="text" name="orderTaxes" id="orderTaxes" value="0" />
	</div>
	<div class="row">
	...
	<div class="row">
		...
		<select	name="deliveryMode" id="deliveryMode">
			...
			<option value="4">4 (Transporteur priv&#233;)</option>
	...
	<div class="row">
		...
		<input type="text" name="deliveryExpectedDate" id="deliveryExpectedDate" value="" />
	</div>
	<div class="row">
		<label for="deliveryExpectedDelay">Expected delivery delay</label>
		<input type="text" name="deliveryExpectedDelay" id="deliveryExpectedDelay" value="" />
	</div>
	<div class="row">
		<h5>Order details</h5>
    </div>
    	...
    	<tr>
    		<td>
				...
				<div class="row">
					...
					<input type="text" name="orderDetailCategory1" id="orderDetailCategory1" value="cat1" />
				</div>
				<div class="row">
    		...
    		<td>
				...
				<div class="row">
					...
					<input type="text" name="orderDetailCategory2" id="orderDetailCategory2" value="cat2" />
				</div>
				<div class="row">
